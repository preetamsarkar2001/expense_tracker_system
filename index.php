...
<head>
    ...
    <title><?= ucwords($title) ?> | Expense and Earnings Tracker App</title>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary bg-gradient" id="topNavBar">
        <div class="container">
            ...
            Expense and Earnings Tracker App
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?php echo ($page == 'expenses')? 'active' : '' ?>" aria-current="page" href="./?page=expenses">Expenses</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?php echo ($page == 'earnings')? 'active' : '' ?>" aria-current="page" href="./?page=earnings">Earnings</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?php echo ($page == 'wallet')? 'active' : '' ?>" aria-current="page" href="./?page=wallet">Wallet</a>
                    </li>
                    <?php endif; ?>
                </ul>
            </div>
